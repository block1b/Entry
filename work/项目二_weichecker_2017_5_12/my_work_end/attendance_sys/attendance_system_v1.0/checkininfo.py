...
class CheckInInfo(object):
    def __init__(self, tec_id, course_id, course_filename, stu_filename, seq_filename):
        ...
        self.seqid = str(self.seq.get_seqid(tec_id, course_id, self.seq.get_all_seq_info(seq_filename)) + 1)
    ...
    def get_checkin_classnames(self, teacher_id, course_id, course_filename):
        ...
        # 所需班级集合
        classnames = self.course.get_classnames(teacher_id, course_id,  a_teacher_course_infos)
        return classnames
