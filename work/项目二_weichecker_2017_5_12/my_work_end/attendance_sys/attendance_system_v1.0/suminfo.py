...
class SumInfo(BaseFile):
    ...
    # sum 文件名构建
    def set_sum_filename(self, teacherID, courseID, default_path="../outputdemo/"):
        sum_filename = default_path + teacherID + "_" + courseID + "_sum.csv"
        return sum_filename
    ...
    # 更新sum表数据
    def sum_update(self, stu_checkin_result, sum_info, seqid):
        checkinseqid = self.set_checkinseqid(seqid)
